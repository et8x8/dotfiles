...
- [ ] 各 Draft ADR に **`## Acceptance criteria` (受け入れ条件)** があり、本文だけで検証可能か (`references/guardrails.md` の「成果物記述における前後工程参照の禁止」に違反する委ねがないか)
...
- [ ] 各 Draft ADR が `references/guardrails.md` の行数・トークン目安に照らし**過大でないか** (500 行超は分割漏れとして報告)
