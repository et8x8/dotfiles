...
**`## Recommendations` 節は Active 化のたびに丸ごと削除**する (`guardrails.md` の「Draft ADR のレコメンド」)。見出しから次の同階層見出し直前までを除去し、Active / Archive ADR に残さない。
...
`guardrails.md` の「設計ドキュメントのインデックス (`index.md`)」に従い、Active 化・Archive 化のあと **`docs/adr/active/index.md` を更新**する。
